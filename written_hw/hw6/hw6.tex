...
\end{itemize}
However, if you prefer to use other resources,
...
\begin{itemize}
    ...
    environment for this. You should also note if you did not use any additional resources.
\end{itemize}
...
Prove that $\mathsc{NeverReject}$ is undecidable via \EMPH{diagonalization}.
