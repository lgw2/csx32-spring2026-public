...
\item Are all classical \textbf{reversible} operations also valid quantum operations? If not,
give a countereample. If yes, explain why. 

\item Prove that the Hadamard operation on two qubits (as seen in class) is a unitary operation.

\item Explain why, given $n$ qubits, the operation that applies the Hadamard opertion to each qubit
