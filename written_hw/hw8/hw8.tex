...
\item
Describe a small graph $X$ with the following property: In every almost 3-coloring of $X$, every vertex of $X$ has \emph{exactly} one neighbor with the same color.
