...
\textsc{Reject}(M) = \emptyset \}$ from last homework. 
 ...
 Your proof must show that your reduction gives the correct answer for all inputs to the problem you are reducing from.
 You must also list all Turing machines in your reduction and give a short description of their role in the reduction (as in the problem session examples).
...
the following language is undecidable via \EMPH{reduction}. 
 Your proof must show that your reduction gives the correct answer for all inputs to the problem you are reducing from.
 You must also list all Turing machines in your reduction and give a short description of their role in the reduction (as in the problem session examples).
...
\begin{itemize}
\item[+ 3] for a correct reduction
\item[+1] for a correct list of the Turing machines used in the reduction, and a short description of their role in the reduction
\item[+ 3] for ''if" proof
\item[+ 3] for ''only if" proof
\item Mortal sins (no points if you do these things): Reduce in the wrong direction; assume that you can tell the difference between looping and halting on some input
\end{itemize}
