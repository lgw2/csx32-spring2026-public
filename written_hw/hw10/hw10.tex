...
\item In class, we gave a hand-wavy argument for why the Euclidean Algorithm, $gcd(a,b)$, has logarithmic runtime in terms of the values of $a$ or $b$.
...
\item Use induction on $k$ to show that the smallest \emph{size} input to $gcd(a,b)$
...
\begin{itemize}
    ...
    \item What is the induction hypothesis? (Assume ... for all $k' < k$)
    ...
    \emph{what you are trying to prove} and that you have proved it (using the induction hypothesis, of course!).
